...
const SQLiteScreen = () => {
    ...
    ExecuteQuery = ( sql, params = []) => new Promise((resolve, reject) => {
        db.transaction((tx) => {
            tx.executeSql(sql, params, (sqlTxn, res) => {
...
export const getAllSeance = async () => {
    let seances = await ExecuteQuery("SELECT DISTINCT * FROM seance", []);
    console.log("seances")
    console.log(seances)
    let rows = seances.rows;
    let results = [];
    for (let i = 0; i < rows.length; i++) {
        let item = rows.item(i);                 
         installReactHook.push({ id: item.id, libeller_long: item.libeller_long, libeller_court: item.libeller_court });
    }
    console.log(results);
}
...
const initData = async () => {
    await db.transaction(async (tx) => {
        ...
        console.log("db init progression");
        await tx.executeSql("INSERT INTO progression (Exercice_id, poid, req, note) VALUES (1, 45, 6, 'top'),"
            + "  (2, 45, 20, 'top'), (3,  70, 10, 'top'), (4, 45, 19, 'top'), (5, 55, 7, 'top'),"
            + "  (6, 60, 6, 'top'), (7, 40, 6, 'top'), (8, 60, 9, 'top'),"
            + "  (9, 22, 9, 'top'), (10, 7.5, 19, 'top'), (11, 5, 18, 'top'), (12, 45, 18, 'top'),"
            + "  (13, 25, 15, 'top'), (14, 65, 10, 'top'), (15, 26, 9, 'top'), (16, 15, 20, 'top'),"
            + "  (17, 110, 7, 'top'), (18, 25, 12, 'top'), (19, 7.5, 16, 'top'), (20, 100, 18, 'top'),"
            + "  (21, 20, 6, 'top'), (22, 14, 6, 'top'), (20, 5, 18, 'top'), (20, 5, 18, 'top'),"
            + "  (20, 12, 8, 'top'), (20, 27.5, 10, 'top'), (20, 27.5, 15, 'top'),"
            + "  (20, 0, 15, 'top'), (20, 0, 0, 'top');",
            [],
            (sqlTxn, res) => { console.log("init progression successfully"); },
            error => { console.log("error on creating table " + error.message); })

        console.log("db init seance");
        await tx.executeSql("INSERT INTO seance (id, jour, libeller_long, libeller_court) VALUES"
            + "  (1, 'Dimanche', 'Seance 1', 'S1'), (2, 'Mardi', 'Seance 2', 'S2'),"
            + "  (3, 'Mercredi', 'Seance 3', 'S3'), (4, 'Jeudi', 'Seance 4', 'S4'),"
            + "  (5, 'vendredi', 'Seance 5', 'S5');",
            [],
            (sqlTxn, res) => { console.log("init data successfully"); },
            error => { console.log("error on creating table " + error.message); })

        console.log("db init exercice");
        await tx.executeSql("INSERT INTO exercice (id, Seance_id, libeller_long, libeller_court, serie, req_min, req_max, pause_min, pause_max) VALUES"
        ...
        console.log("db init echauffement");
        await tx.executeSql("INSERT INTO echauffement (id, poid, req, pause) VALUES"
            + "  (0, '0', '0', '0'), (1, '0', '20', '60'), (2, '30', '15', '90'),"
            + "  (3, '40', '10', '120'), (4, '0', '20', '60'), (5, '40', '15', '90'),"
            + "  (6, '60', '10', '12'), (7, '0', '20', '60'), (8, '40', '15', '90'),"
            + "  (9, '60', '10', '120'), (10, '0', '20', '60'), (11, '40', '15', '90'),"
            + "  (12, '60', '10', '120'), (13, '0', '20', '60'), (14, '10', '15', '90'),"
            + "  (15, '0', '20', '60'), (16, '50', '15', '90'), (17, '80', '10', '120'),"
            + "  (18, '0', '20', '60'), (19, '4', '15', '90'), (20, '6', '10', '120'),"
            + "  (21, '5', '15', '60'), (22, '8', '10', '120'), (23, '5', '30', '0'),"
            + "  (24, '5', '30', '0'), (25, '5', '30', '0');",
            [],
            (sqlTxn, res) => { console.log("init data successfully"); },
            error => { console.log("error on creating table " + error.message); })

        console.log("db init types_muscles");
        await tx.executeSql("INSERT INTO types_muscles (id, libeller_long) VALUES"
            + "  (1, 'Quadriceps'), (2, 'Ischios'), (3, 'Dos'),"
            + "  (4, 'Mollet'), (5, 'Grand pectoral'), (6, 'Petit pectoral'),"
            + "  (7, 'Deltoide Postérieur'), (8, 'Deltoide externe'), (9, 'Abdos'),"
            + "  (10, 'Grand Dorsal'), (11, 'Dorsal latéral'), (12, 'Pectoreaux'),"
            + "  (13, 'Triceps'), (14, 'Jambes'), (15, 'Deltoide'),"
            + "  (16, 'Deltoide Latérale'), (17, 'Biceps');",
            [],
            (sqlTxn, res) => { console.log("init data successfully"); },
            error => { console.log("error on creating table " + error.message); })

        console.log("db init seance_exercice_types_muscles_echauffement");
        await tx.executeSql(" INSERT INTO seance_exercice_types_muscles_echauffement "
            + " (seance_id, exercice_id, echauffement_id) VALUES"
            + " (1,0,23), (1,0,24), (1,0,25), (1,0,26),"
            + " (1,1,1), (1,1,1), (1,1,2), (1,1,3),"
            + " (1,2,0), (1,3,4),"
            + " (1,3,6), (1,4,0), (1,5,0), (1,6,0),"
            + " (1,7,0), (2,8,7), (2,8,8), (2,8,9), (2,9,0),"
            + " (2,10,0), (2,11,0), (2,12,0), (2,13,0), (3,14,0),"
            + " (4,15,10), (4,15,11), (4,15,12), (4,16,0), (1,3,5),"
            + " (4,17,0), (4,18,13), (4,18,14), (4,19,0), (4,20,0),"
            + " (4,21,15), (4,21,16), (4,21,17),(5,22,18),(5,22,19),"
            + " (5,22,20), (5,23,0), (5,24,0), (5,25,0), (5,26,21),"
            + " (5,26,22), (5,27,0), (5,28,0), (5,29,0), (5,30,0)",
            [],
            (sqlTxn, res) => { console.log("init data successfully"); },
            error => { console.log("error on creating table " + error.message); })
    });
}
const setProgression = async (agrs) => {

    await db.transaction(async (tx) => {
        console.log("db initdata"); 999
        await tx.executeSql("INSERT INTO seance_exercice_types_muscles_echauffement"
            + " (seance_id, exercice_id, echauffement_id) VALUES"
            + " (?, ?, ?)",
            [agrs.seance_id, agrs.exercice_id, agrs.echauffement_id],
            (sqlTxn, res) => { console.log("setProgression successfully"); },
            error => { console.log("error on creating table " + error.message); }
        );
    })
}
const getAllData = async () => {
    ...
    await db.transaction((tx) => {
        ...
        tx.executeSql("SELECT DISTINCT seance.libeller_long, exercice.libeller_long, exercice.serie, exercice.req_min,"
            ...
            [], (sqlTxn, res) => {
                console.log("Select getAllData successfully");
                //console.log(res);
                let len = res.rows.length;
                if (len > 0) {
                    let results = [];
                    for (let i = 0; i < len; i++) {
                        let item = res.rows.item(i);
                        //console.log(item);
                        results.push({ id: item.id, libeller_long: item.libeller_long });
                    }
                }
                setSeances(results)
            },
...
//export { createTables, initData, setProgression, getAllData, getAllSeance };